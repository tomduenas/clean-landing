        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-blue-50 px-4 py-2 rounded-full mb-8">
              ...
              <span className="text-sm font-medium text-blue-600">Introducing the future of productivity</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="group px-8 py-4 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all flex items-center space-x-2 shadow-lg hover:shadow-xl">
                <span>Start free trial</span>
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="px-8 py-4 border-2 border-gray-200 text-gray-700 rounded-lg hover:border-gray-300 transition-colors">
                Watch demo
              </button>
            </div>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 rounded-2xl bg-white border border-gray-100 hover:border-gray-200 hover:shadow-xl transition-all">
            ...
            <div className="group p-8 rounded-2xl bg-white border border-gray-100 hover:border-gray-200 hover:shadow-xl transition-all">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Scale with Ease</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-2xl border-2 border-gray-100 hover:border-gray-200 transition-colors">
              ...
              <button className="w-full px-6 py-3 border-2 border-gray-200 text-gray-700 rounded-lg hover:border-gray-300 transition-colors">
                Get started
              </button>
            </div>
            <div className="bg-gray-900 p-8 rounded-2xl relative transform md:scale-105 shadow-2xl">
            ...
            <div className="bg-white p-8 rounded-2xl border-2 border-gray-100 hover:border-gray-200 transition-colors">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-500 mt-0.5" />
                  <span className="text-gray-600">Custom contracts</span>
                </li>
                <li className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-500 mt-0.5" />
